...
public:
    ...
    void draw(sf::RenderWindow& window, const Simulation& simulation, bool paused, const sf::View& worldView);
...
private:
    ...
    [[nodiscard]] sf::Vector2f minimapPoint(const sf::FloatRect& worldBounds, sf::Vector2f worldPoint, sf::Vector2f minimapTopLeft, sf::Vector2f minimapSize) const;
    ...
    void drawHud(sf::RenderWindow& window, const Simulation& simulation, bool paused, const sf::View& worldView);
    void drawBar(sf::RenderWindow& window, sf::Vector2f position, sf::Vector2f size, float value, sf::Color fill);
    void drawMinimap(sf::RenderWindow& window, const Simulation& simulation, const sf::View& worldView);
